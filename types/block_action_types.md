...
Block Action Types operate an action at a selected block or set of blocks. These are available to rune/action types that provides a `block_action` object field.
...
* [Explode](block_action_types/explode)
