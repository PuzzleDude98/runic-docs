...
Entity Condition Types operate on an Entity, which also allows access to the world. These are available to be used in runes that involve a player interaction, in the `entity_condition` field.
...
* [On Fire](entity_condition_types/on_fire)
