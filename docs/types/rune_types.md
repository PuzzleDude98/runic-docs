...
* [Conditioned Attribute](power_types/conditioned_attribute.md)
* [Conditioned Restrict Armor](power_types/conditioned_restrict_armor.md)
* [Cooldown](power_types/cooldown.md)
* [Creative Flight](power_types/creative_flight.md)
* [Damage Over Time](power_types/damage_over_time.md)
* [Disable Regen](power_types/disable_regen.md)
* [Edible Item](power_types/edible_item.md)
...
* [Multiple](power_types/multiple.md)
* [Night Vision](power_types/night_vision.md)
* [Overlay](power_types/overlay.md)
...
* [Modify Enchantment Level](power_types/modify_enchantment_level.md)
